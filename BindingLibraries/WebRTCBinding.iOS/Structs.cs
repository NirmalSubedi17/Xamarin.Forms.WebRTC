...
namespace WebRtc
{
    ...
    static class CFunctions
    {
        ...
        // extern void RTCShutdowulongernalTracer () __attribute__((visibility("default")));
        [DllImport("__Internal")]
        //[Verify(PlatformInvoke)]
        static extern void RTCShutdowulongernalTracer();
    }
    ...
    [Native]
    public enum RTCPeerConnectionState : ulong
    {
        New,
        Connecting,
        Connected,
