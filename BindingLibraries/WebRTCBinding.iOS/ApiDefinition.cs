...
namespace WebRtc
{
    ...
    interface RTCCVPixelBuffer : IRTCVideoFrameBuffer
    {
        ...
        [Export("pixelBuffer")]
        unsafe CVPixelBuffer PixelBuffer { get; }
        ...
        unsafe IntPtr Constructor(CVPixelBuffer pixelBuffer);
        ...
        unsafe IntPtr Constructor(CVPixelBuffer pixelBuffer, int adaptedWidth, int adaptedHeight, int cropWidth, int cropHeight, int cropX, int cropY);
        ...
        unsafe bool CropAndScaleTo(CVPixelBuffer outputPixelBuffer, [NullAllowed] byte* tmpBuffer);
    }
